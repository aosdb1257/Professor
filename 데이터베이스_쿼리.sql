...
CREATE TABLE lecture_plan (
    ...
    subject_code VARCHAR(10) NOT NULL UNIQUE,          -- 교과 코드 (외래키로 연결 가능)
    subject_name VARCHAR(10) NOT NULL,
    professor_id VARCHAR(20) NOT NULL,          -- 교수 ID (외래키로 연결 가능)
